...
RAW_REPORT_ORIGINAL_WITH_REMOVED_SUBTITLES = {
    'streams':
        [
            {'index': 0, 'codec_name': 'h264',
             ...
             'display_aspect_ratio': '16:9',
             'pix_fmt': 'yuv420p', 'level': 31,
             'color_range': 'tv', 'color_space': 'smpte170m',
             'color_transfer': 'bt709',
             'color_primaries': 'smpte170m',
             'chroma_location': 'topleft',
             'field_order': 'progressive', 'refs': 1,
            ...
            {'index': 1, 'codec_name': 'aac',
             ...
             'channel_layout': 'stereo',
             'bits_per_sample': 0, 'r_frame_rate': '0/0',
             'avg_frame_rate': '0/0', 'time_base': '1/1000',
             'start_pts': 12, 'start_time': '0.012000',
             'disposition': {'default': 1, 'dub': 0,
                             'original': 0, 'comment': 0,
                             'lyrics': 0, 'karaoke': 0,
            ...
            {'index': 8, 'codec_name': 'aac',
             ...
             'codec_tag': '0x0000', 'sample_fmt': 'fltp',
             'sample_rate': '22050', 'channels': 1,
             'channel_layout': 'mono', 'bits_per_sample': 0,
    ...
    'format': {
        ...
        'format_name': 'matroska,webm',
        'format_long_name': 'Matroska / WebM',
        'start_time': '0.000000', 'duration': '46.665000',
        'size': '31762747', 'bit_rate': '5445236',
        'probe_score': 100, 'tags': {
            'encoder': 'libebml v1.0.0 + libmatroska v1.0.0',
            'creation_time': '2010-08-21T18:06:43.000000Z',
    ...
    'streams':
        [
            ...
            {'index': 1, 'codec_name': 'aac',
             ...
             'tags': {'language': 'eng',
                      'title': 'Commentary',
                      'DURATION': '00:00:46.030000000'}},
            {'index': 2, 'codec_name': 'h264',
             'codec_long_name': 'H.264 / AVC / MPEG-4 AVC / MPEG-4 part 10',
             'profile': 'Main', 'codec_type': 'video',
             'codec_time_base': '1/48',
             'codec_tag_string': '[0][0][0][0]',
             ...
             'disposition': {'default': 1, 'dub': 0,
                             ...
                             'timed_thumbnails': 0},
             'tags': {
                 'DURATION': '00:00:45.999000000'}}
        ],
    'format': {
        'filename': '/golem/resources/test5_shuffled.mkv',
        'nb_streams': 3, 'nb_programs': 0,
        'format_name': 'matroska,webm',
        'format_long_name': 'Matroska / WebM',
        'start_time': '0.000000', 'duration': '46.030000',
