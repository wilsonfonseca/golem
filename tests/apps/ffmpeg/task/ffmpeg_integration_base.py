...
class FfmpegIntegrationBase(TestTaskIntegration):
    ...
    _IGNORED_ATTRIBUTES_OF_BROKEN_FILE = {
        ...
        'standalone-tra3106[mjpeg,720x496,17s,v1a0s0d0,i1525p1016b1016,29.97fps][segment1of17].avi': {
            'video': {'frame_rate'}},
        ...
        'standalone-catherine[wmv3+wmav2,180x140,42s,v1a1s0d0,i637p1257b631,_][segment1of6].wmv': {
            'video': {'frame_rate'}},
    }
    ...
    def split_and_merge_with_codec_change(self,
                                               video,
                                               video_codec,
                                               container):
    ...
    def split_and_merge_with_different_subtask_counts(self,
                                                           video,
                                                           subtasks_count):
        # FIXME: These tests should be re-enabled once all the fixes needed
        # to make them pass are done and merged.
