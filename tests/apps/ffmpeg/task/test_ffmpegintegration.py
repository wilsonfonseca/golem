...
class TestFfmpegIntegration(TestTaskIntegration):
    ...
    VIDEO_FILES = [
        ...
        {"resolution": [1920, 1080], "container": Container.c_MPEG,     "video_codec": VideoCodec.MPEG_2,    "path": "videos/good/beachfront-dandelion[mpeg2video+mp2,1920x1080,20s,v1a1s0d0,i1765p1925b1604,23.976fps][segment1of5].mpeg"},
        ...
        {"resolution": [1024, 576],  "container": Container.c_MATROSKA, "video_codec": VideoCodec.H_264,     "path": "videos/good/matroska-test5[h264+aac+aac,1024x576,47s,v1a2s0d8,i1149p1655b1609,24fps][segment1of10].mkv"},
        ...
        {"resolution": [1920, 1080], "container": Container.c_FLV,      "video_codec": VideoCodec.FLV1,      "path": "videos/good/standalone-jellyfish[flv1,1920x1080,30s,v1a0s0d0,i1874p2622b1798,29.9697fps][segment1of6].flv"},
        {"resolution": [1408, 1152], "container": Container.c_3GP,      "video_codec": VideoCodec.H_263,     "path": "videos/good/standalone-jellyfish[h263,1408x1152,30s,v1a0s0d0,i1874p2622b1798,29.97fps][segment1of6].3gp"},
        ...
        {"resolution": [320, 240],   "container": Container.c_MOV,      "video_codec": VideoCodec.MJPEG,     "path": "videos/good/standalone-p6090053[mjpeg+pcm_u8,320x240,30s,v1a1s0d0,i1123p748b748,12.5fps][segment1of6].mov"},
        ...
        {"resolution": [1920, 1080], "container": Container.c_MPEGTS,   "video_codec": VideoCodec.H_264,     "path": "videos/good/standalone-panasonic[h264+ac3,1920x1080,46s,v1a1s0d1,i1247p1439b1919,25fps][segment1of10].mts"},
        ...
        {"resolution": [704, 576],   "container": Container.c_3GP,      "video_codec": VideoCodec.H_263,     "path": "videos/good/standalone-tra3106[h263,704x576,17s,v1a0s0d0,i1069p1472b1016,29.97fps][segment1of4].3gp"},
        {"resolution": [720, 496],   "container": Container.c_AVI,      "video_codec": VideoCodec.MJPEG,     "path": "videos/good/standalone-tra3106[mjpeg,720x496,17s,v1a0s0d0,i1525p1016b1016,29.97fps][segment1of4].avi"},
        ...
        {"resolution": [1920, 1080], "container": Container.c_MOV,      "video_codec": VideoCodec.MJPEG,     "path": "videos/bad/beachfront-moonandclouds[mjpeg,1920x1080,50s,v1a0s0d0,i3574p2382b2382,24fps].mov"},
        {"resolution": [1920, 1080], "container": Container.c_MOV,      "video_codec": VideoCodec.MJPEG,     "path": "videos/bad/beachfront-mooncloseup[mjpeg,1920x1080,33s,v1a0s0d0,i2374p1582b1582,23.976fps].mov"},
        {"resolution": [854, 480],   "container": Container.c_MATROSKA, "video_codec": VideoCodec.MSMPEG4V2, "path": "videos/bad/matroska-test1[msmpeg4v2+mp3,854x480,87s,v1a1s0d0,i4215p6261b4190,24fps].mkv"},
        ...
        {"resolution": [1920, 1080], "container": Container.c_MOV,      "video_codec": VideoCodec.H_264,     "path": "videos/bad/natureclip-relaxriver[h264+aac,1920x1080,20s,v1a1s0d0,i606p1192b599,29.97fps].mov"},
        ...
        {"resolution": [720, 480],   "container": Container.c_SVCD,     "video_codec": VideoCodec.MPEG_2,    "path": "videos/bad/standalone-dolbycanyon[mpeg2video+ac3,720x480,38s,v1a1s0d0,i3574p3801b4257,29.97fps].vob"},
        {"resolution": [560, 320],   "container": Container.c_MPEG,     "video_codec": VideoCodec.MPEG_2,    "path": "videos/bad/standalone-small[mpeg2video+mp2,560x320,6s,v1a1s0d0,i523p661b509,30fps].mpg"},
        {"resolution": [720, 496],   "container": Container.c_MPEG,     "video_codec": VideoCodec.MPEG_2,    "path": "videos/bad/standalone-tra3106[mpeg2video,720x496,17s,v1a0s0d0,i1642p2033b1583,29.97fps].mpeg"},
        {"resolution": [320, 240],   "container": Container.c_MPEG,     "video_codec": VideoCodec.MPEG_2,    "path": "videos/bad/standalone-videosample[mpeg2video,320x240,59s,v1a0s0d0,i45135p57013b43947,240fps].mpg"},
        {"resolution": [560, 320],   "container": Container.c_OGG,      "video_codec": VideoCodec.THEORA,    "path": "videos/bad/techslides-small[theora+vorbis,560x320,6s,v1a1s0d0,i168p328b165,30fps].ogv"},
    ]
